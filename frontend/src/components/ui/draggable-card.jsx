...
export const DraggableCardBody = ({ className, children }) => {
  ...
  return (
    <motion.div
      ...
      className={cn(
        "relative min-h-96 w-80 overflow-hidden rounded-xl bg-neutral-800 border border-neutral-600 p-6 shadow-2xl transform-3d",
        className
      )}
    >
      {children}
      <motion.div
        ...
        className="pointer-events-none absolute inset-0 bg-neutral-400 select-none opacity-10"
      />
    </motion.div>
  )
}

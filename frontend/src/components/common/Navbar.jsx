    ...
    <nav className="w-full sticky top-0 z-50 bg-white border-b-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 lg:h-20">
          {/* Logo */}
          <div className="flex items-center space-x-2 lg:space-x-3 cursor-pointer hover:scale-105 transition-transform duration-300">
            <div className="w-10 h-10 lg:w-12 lg:h-12 bg-black flex items-center justify-center rotate-12 hover:rotate-0 transition-transform duration-300 border-2 border-black">
              <span className="text-xl lg:text-2xl">💬</span>
            </div>
            <span className="text-xl lg:text-3xl font-black tracking-tighter whitespace-nowrap">
              HUSHHHH...
            </span>
          </div>
